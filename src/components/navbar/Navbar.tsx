...
import { ListIcon, XIcon, HouseIcon, CarrotIcon, UserIcon } from '@phosphor-icons/react';
...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#36073d] border-b  shadow-md">
