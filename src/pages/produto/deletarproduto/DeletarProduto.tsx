export function DeletarProduto() {
  return (
    <div className="container mx-auto p-8 text-center max-w-lg">
      <h1 className="text-3xl font-bold mb-4" style={{color: 'var(--destaque)'}}>Deletar Produto?</h1>
      <p className="mb-8 text-gray-600">Tem certeza que deseja apagar o produto <strong>"Suco Verde"</strong>? Essa ação não pode ser desfeita.</p>
